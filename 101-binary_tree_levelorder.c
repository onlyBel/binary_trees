...
/**
 * binary_tree_levelorder - Goes through a binary treeusing level-order traversal.
 * @tree: Pointer to the rootnode of the tree to traverse.
 * @func: Pointer to afunctionto call for each node.
 */
...
/**
 * append - adds a new node at the end of linkedlist
 * @head: pointer to head of linked list
 * @btnode: const binary tree node toappend
 * Return: pointer to head, on failure NULL
 */
ll *append(ll *head, const binary_tree_t *btnode)
{
...
/**
 * free_list - frees nodes in a linked list
 * @head: pointer to thehead of list_t linked list
 */
void free_list(ll *head)
{
        ll *ptr = NULL;
